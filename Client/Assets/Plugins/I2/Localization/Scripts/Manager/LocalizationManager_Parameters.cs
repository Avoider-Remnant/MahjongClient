...
namespace I2.Loc
{
    public static partial class LocalizationManager
    {
        ...
        {
            ApplyLocalizationParams(ref translation, p => GetLocalizationParam(p, (GameObject) null), allowLocalizedParameters);
        }
        ...
        public static void ApplyLocalizationParams(ref string translation, Dictionary<string, string> replacement, bool allowLocalizedParameters = true)
        {
            ApplyLocalizationParams(ref translation, p => GetLocalizationParam(p, replacement), allowLocalizedParameters);
        }
        ...
        internal static string GetLocalizationParam(string ParamName, Dictionary<string, string> replacements)
        {
            if (replacements is null || !replacements.ContainsKey(ParamName))
            {
                return null;
            }

            return replacements[ParamName];
        }
